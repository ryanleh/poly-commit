...
use ark_poly_commit::{LabeledPolynomial, PolynomialCommitment, marlin_pc::MarlinKZG10};
use ark_std::cmp::min;
use ark_bls12_381::{Bls12_381, Fr as BlsFr};
use criterion::BenchmarkId;
use criterion::{criterion_group, criterion_main, Bencher, Criterion};

const BENCHMARK_MIN_DEGREE: usize = 1 << 13;
...
fn setup_bench<E: PairingEngine, P: UVPolynomial<E::Fr>, PC: PolynomialCommitment<E::Fr, P>>(c: &mut Criterion, name: &str, bench_fn: fn(&mut Bencher, &usize)) {
...
fn bench_poly_commit<E: PairingEngine, P: UVPolynomial<E::Fr>, PC: PolynomialCommitment<E::Fr, P>>(b: &mut Bencher, degree: &usize) {
    // Per benchmark setup
    // TODO: Add degree bound
    let rng = &mut test_rng();

    let label = format!("Test_{}", degree);
    ...
    let polynomial = vec![LabeledPolynomial::new(
        label,
    ...
    b.iter(|| {
        PC::commit(&ck, &polynomial, Some(rng)).unwrap();
    });
}

fn poly_commit_benches<E: PairingEngine, P: UVPolynomial<E::Fr>, PC: PolynomialCommitment<E::Fr, P>>(c: &mut Criterion, engine: &'static str, pc: &'static str) {
...
fn bench_kzg10_bls12_381(c: &mut Criterion) {
    ...
    let pc = "MarlinKZG10";
    poly_commit_benches::<Bls12_381, DensePolynomial<BlsFr>, MarlinKZG10<Bls12_381, DensePolynomial<BlsFr>>>(c, engine, pc);
